...
async def get_response(user_input: UserInput):
    ...
    try:
        ...
        # If no relevant answer is found on the website
        if response['answer'].strip() == "":
            ...
            # Check if there is a previous question in chat history
            if session_data["chat_history"]:
                ...
                return {"agent_response": fallback_response,"answer": fallback_response}
        else:
